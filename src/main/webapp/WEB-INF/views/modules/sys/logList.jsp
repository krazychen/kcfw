	...
	<form:form id="searchForm" action="${ctx}/sys/log/" method="post"  class="form-inline">
		...
		<div class="row" >
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
				<div class="form-group">
					<label for="exception">
					<input id="exception" name="exception" class="i-checks" type="checkbox"${log.exception eq '1'?' checked':''} value="1"/>只查询异常信息</label>
		 		</div>	
		 	</div>
		 </div>
	</form:form>
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		...
		<c:forEach items="${page.list}" var="log">
			<tr>
				...
				<td><fmt:formatDate value="${log.createDate}" type="both" pattern="yyyy-MM-dd HH:mm:dd"/></td>
			</tr>
