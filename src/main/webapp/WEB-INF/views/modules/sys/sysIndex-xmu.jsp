...
<head>
    ...
    <meta name="keywords" content="kcfw">
    <meta name="description" content="kcfw">
...
<body class="fixed-sidebar full-height-layout gray-bg">
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="footer">
                <!-- <div class="pull-left">Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://kcfw.com" target="_blank">kcfw</a> ${fns:getConfig('version')}</div> -->
            </div>
        </div>
        <!--右侧部分结束-->
