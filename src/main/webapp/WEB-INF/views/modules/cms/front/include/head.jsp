...
<meta name="author" content="http://krazy.iteye.com"/><meta http-equiv="X-UA-Compatible" content="IE=7,IE=9,IE=10" />
<meta http-equiv="Content-Security-Policy" content="script-src 'self' 'unsafe-inline' http://*.cnzz.com">
...
<c:if test="${site.theme eq 'basic'}">
	...
	<link href="${ctxStatic}/common/kcfw.min.css" type="text/css" rel="stylesheet" />
