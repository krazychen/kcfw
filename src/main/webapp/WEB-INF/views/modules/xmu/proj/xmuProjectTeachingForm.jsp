				...
				<div id="tab-5" class="tab-pane">
					...
					<script type="text/template" id="xmuProjectTeachingTpl">//<!--
						<tr id="xmuProjectTeachingList{{idx}}">
							...
							<td>
								<select id="xmuProjectTeachingList{{idx}}_xptTeachingTitle" name="xmuProjectTeachingList[{{idx}}].xptTeachingTitle" data-value="{{row.xptTeachingTitle}}" multiple="multiple" class="input-mini" style="height:25px;width:150px;*width:200px">
									<option value=""></option>
					...
					<script type="text/javascript">
						...
						$(document).ready(function() {
							...
							for (var i=0; i<data.length; i++){
								...
								var temp="#xmuProjectTeachingList"+xmuProjectTeachingRowIdx+"_xptTeachingTitle";
								$(temp).select2();
