			...
			<tr>
				...
				<td>
					<shiro:hasPermission name="xmu:res:xmuWinningInfo:view">
						<a href="#" onclick="openDialogView('查看获奖信息', '${ctx}/xmu/res/xmuWinningInfo/form?id=${xmuWinningInfo.id}','800px', '500px')" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 查看</a>
					</shiro:hasPermission>
					<shiro:hasPermission name="xmu:res:xmuWinningInfo:edit">
