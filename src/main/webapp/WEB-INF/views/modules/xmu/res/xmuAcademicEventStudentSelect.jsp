	...
	<script type="text/javascript">
		...
		function getSelectedItem(){
		    ...
		    $("#contentTable tbody tr td input.i-checks:checkbox:checked").each(function () {
                ids.push(this.id);
                ids.push($(this).attr("xpuUserStuno"));
                ids.push($(this).attr("xpsUserName"));
                ids.push($(this).attr("xpuUserGrade"));
                ids.push($(this).attr("xpuUserProfession"));
                ids.push($(this).attr("xpsOfficeId"));
                ids.push($(this).attr("xpsOfficeName"));
            });
...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="xmuProjectStudent" action="${ctx}/xmu/res/xmuAcademicEvent/listStu" method="post" class="form-inline">
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		...
		<c:forEach items="${page.list}" var="xmuProjectStudent">
			<tr>
				<td> <input type="checkbox" id="${xmuProjectStudent.xpsUserId}" xpuUserStuno="${xmuProjectStudent.xpuUserStuno}"
				xpsUserName="${xmuProjectStudent.xpsUserName}" xpuUserGrade="${xmuProjectStudent.xpuUserGrade}" 
				xpuUserProfession="${xmuProjectStudent.xpuUserProfession}" 
				xpsOfficeId="${xmuProjectStudent.xpsOfficeId}" xpsOfficeName="${xmuProjectStudent.xpsOfficeName}"
				 class="i-checks"></td>
				...
				<td>
					${fns:getDictLabel(xmuProjectStudent.xpuUserGrade, 'XMU_PROJECT_COR_GRADE', '')}
				</td>
				<td>
					${fns:getDictLabel(xmuProjectStudent.xpuUserProfession, 'XMU_PROJECT_COR_PROFESSION', '')}
				</td>
				<td>
