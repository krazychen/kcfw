		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						<input readonly="true" id="xpiResearchYears" name="xpiResearchYears" type="text" maxlength="20" class="laydate-icon form-control layer-date formDateMaxWidth "
							value="${xmuReserachInfo.xpiResearchYears}"/>
					</td>
					<td class="width-15 active"><label class="pull-right">科研项目名称：</label></td>
					<td class="width-35">
						<form:input readonly="true" path="xpiResearchName" htmlEscape="false" maxlength="200" class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">科研项目类型：</label></td>
					<td class="width-35">
						<form:select readonly="true" path="xpiResearchType" class="form-control ">
							<form:option value="" label=""/>
					...
					<td class="width-35">
						<form:select readonly="true" path="xpiResearchLevel" class="form-control ">
							<form:option value="" label=""/>
				...
				<tr>					
					...
					<td class="width-35">
						<form:input readonly="true" path="xpiResearchTeacher" htmlEscape="false" maxlength="64" class="form-control "/>
					</td>
				</tr>
		 	</tbody>
		</table>
