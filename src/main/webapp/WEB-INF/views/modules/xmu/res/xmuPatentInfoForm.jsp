		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
					...
					<td class="width-35">
						...
						<c:if test="${fn:contains(role, 'Manager')}" >
							<div class="input-group">
								<input id="xpiUserStuno"  name="xpiUserStuno" readonly="readonly" type="text" value="${xmuPatentInfo.xpiUserStuno}" class="form-control "/>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="xpiPatentName" htmlEscape="false" maxlength="200" class="form-control required"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="xpiPatentPno" htmlEscape="false" maxlength="64" class="form-control required"/>
					</td>
					<td class="width-15 active"><label class="pull-right">申请公开日：</label></td>
					<td class="width-35">
						<input id="xpiPatentPtime" name="xpiPatentPtime" type="text" maxlength="20" class="laydate-icon form-control layer-date formDateMaxWidth "
				...
				<tr>
					...
					<td colspan="5">
						<form:textarea path="xpiPatentRemark" htmlEscape="false" rows="4" maxlength="2000" class="form-control "/>
					</td>
				</tr>
		 	</tbody>
		</table>
