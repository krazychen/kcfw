		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
					...
					<td class="width-35">
						...
						<c:if test="${fn:contains(role, 'Manager')}" >
							<div class="input-group">
								<input id="xoeUserStuno"  name="xoeUserStuno" readonly="readonly" type="text" value="${xmuOutsideExchange.xoeUserStuno}" class="form-control "/>
					       		 <span class="input-group-btn">
						       		 <button type="button" onclick="addStu();" id="xoeUserStunoButton" class="btn btn-primary"><i class="fa fa-search"></i>
						             </button> 
					       		 </span>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="xoeExchangeArea" htmlEscape="false" maxlength="200" class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">交流学校：</label></td>
					<td class="width-35">
						<form:input path="xoeExchangeSchool" htmlEscape="false" maxlength="64" class="form-control "/>
					</td>
				...
				<tr>
					...
					<td class="width-35">
						<form:select path="xoeExchangeType" class="form-control ">
							<form:option value="" label=""/>
					...
					<td class="width-35">
						<form:select path="xoeExchangeWay" class="form-control ">
							<form:option value="" label=""/>
