		...
		<fieldset>
			<table class="table-form">	
				<tr>
					...
					<td>
						<form:input path="scrName" htmlEscape="false" maxlength="100" class="input-large required editFormFieldWidth"/>
					</td>
					...
					<td>
						<form:select path="scrIndustry" class="input-large required editFormFieldWidth">
					...
					<td>
						<form:select path="scrCoopMethod" class="input-large required editFormFieldWidth">
							<form:option value="" label=""/>
				...
				<tr>
					...
					<td colspan="5">
						<form:textarea path="scrContent" htmlEscape="false" rows="3" maxlength="2000" class="input-xxlarge required"/>
					</td>
				</tr>
				<tr>
					<td class="tit">
					...
					<td colspan="5">
						<form:textarea path="scrMarket" htmlEscape="false" rows="3" maxlength="2000" class="input-xxlarge "/>
					</td>
				</tr>
				<tr>
					...
					<td>
						<form:input path="scrCompanyName" htmlEscape="false" maxlength="64" class="input-large required editFormFieldWidth"/>
					</td>
					<td class="tit">
						<span class="help-inline"><font color="red">*</font> </span>联系人：
					</td>
					<td>
						<form:input path="scrCompanyContact" htmlEscape="false" maxlength="64" class="input-large required editFormFieldWidth"/>
					</td>
					<td class="tit">
						<span class="help-inline"><font color="red">*</font> </span>联系电话：
					</td>
					<td>
						<form:input path="scrCompanyPhone" htmlEscape="false" maxlength="64" class="input-large required editFormFieldWidth"/>
					</td>
				</tr>
				<tr>
