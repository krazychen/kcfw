...
public class XmuProjectStudent extends DataEntity<XmuProjectStudent> {
	...
	private String xpuUserGradeName;		// 年级
	private String xpuUserProfession;		// 专业
	private String xpuUserProfessionName;		// 年级
	...
	/**
	 * @return the xpuUserGradeName
	 */
	public String getXpuUserGradeName() {
		return xpuUserGradeName;
	}

	/**
	 * @param xpuUserGradeName the xpuUserGradeName to set
	 */
	public void setXpuUserGradeName(String xpuUserGradeName) {
		this.xpuUserGradeName = xpuUserGradeName;
	}

	/**
	 * @return the xpuUserProfessionName
	 */
	public String getXpuUserProfessionName() {
		return xpuUserProfessionName;
	}

	/**
	 * @param xpuUserProfessionName the xpuUserProfessionName to set
	 */
	public void setXpuUserProfessionName(String xpuUserProfessionName) {
		this.xpuUserProfessionName = xpuUserProfessionName;
	}
