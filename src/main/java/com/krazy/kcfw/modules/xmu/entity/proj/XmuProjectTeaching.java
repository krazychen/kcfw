...
public class XmuProjectTeaching extends DataEntity<XmuProjectTeaching> {
	...
	private String xptTeachingTitleStr;
	private List teachingIdList;
	
	
	
	/**
	 * @return the xptTeachingTitleStr
	 */
	public String getXptTeachingTitleStr() {
		return xptTeachingTitleStr;
	}

	/**
	 * @param xptTeachingTitleStr the xptTeachingTitleStr to set
	 */
	public void setXptTeachingTitleStr(String xptTeachingTitleStr) {
		this.xptTeachingTitleStr = xptTeachingTitleStr;
	}
