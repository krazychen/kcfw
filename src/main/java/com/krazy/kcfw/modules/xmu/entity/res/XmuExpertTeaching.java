...
public class XmuExpertTeaching extends DataEntity<XmuExpertTeaching> {
	...
	private String xetExpertTitleStr;	
	

	
	/**
	 * @return the xetExpertTitleStr
	 */
	public String getXetExpertTitleStr() {
		return xetExpertTitleStr;
	}

	/**
	 * @param xetExpertTitleStr the xetExpertTitleStr to set
	 */
	public void setXetExpertTitleStr(String xetExpertTitleStr) {
		this.xetExpertTitleStr = xetExpertTitleStr;
	}
