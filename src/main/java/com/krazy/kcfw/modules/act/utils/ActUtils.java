 ...
 */
package com.krazy.kcfw.modules.act.utils;
...
import com.krazy.kcfw.common.annotation.FieldName;
...
//	}
	...
	public static String getFormUrl(String formKey, Act act){
		...
		formUrl.append("&act.assignee=").append(act.getAssignee()!= null ? act.getAssignee() : "");
