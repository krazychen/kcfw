...
import com.krazy.kcfw.common.utils.CookieUtils;
...
//		try {
//			byte[] bytes = com.krazy.kcfw.common.utils.FileUtils.readFileToByteArray(
//					com.krazy.kcfw.common.utils.FileUtils.getFile("c:\\sxt.dmp"));
